...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{big}}\}|\{\textcolor{Black}{\textbf{small}}\})}\textcolor{Black}{\textbf{log}} }
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{(\syntax{(\{\textcolor{Black}{\textbf{большое}}\}|\{\textcolor{Black}{\textbf{small}}\})%
[\textcolor{Black}{\textbf{unval}}]}\textcolor{Black}{\textbf{z}}|\textcolor{Black}{\textbf{unvalн8}}|\textcolor{Black}{\textbf{unval16}}|\textcolor{Black}{\textbf{unval32}}|\textcolor{Black}{\textbf{unval64}}|\\
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{big}}\}|\{\textcolor{Black}{\textbf{small}}\})}\textcolor{Black}{\textbf{r}}|\textcolor{Black}{\textbf{r32}}|\textcolor{Black}{\textbf{r64}}|\textcolor{Black}{\textbf{r80}}|\textcolor{Black}{\textbf{r128}}}
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\{\textcolor{Black}{\textbf{big}}\}|\{\textcolor{Black}{\textbf{small}}\})}\textcolor{Black}{\textbf{c}}|\textcolor{Black}{\textbf{c32}}|\textcolor{Black}{\textbf{c64}}|\textcolor{Black}{\textbf{c80}}|\textcolor{Black}{\textbf{c128}}}
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\textcolor{Black}{\textbf{link}}|\textcolor{Black}{\textbf{const link}})\synt{простейшее_определение_типа}}}
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\textcolor{Black}{\textbf{function}} \synt{сигнатура} }
\end{center}
...
\begin{center}
\noindent\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{array}}\textcolor{Black}{[} [\synt{выражение}]\{\textcolor{Black}{,}[\synt{выражение}]\} \textcolor{Black}{]}%
...
\begin{center}
\textbf{array}[\texttt{N}$_{m}$,\dots,\texttt{N}$_{m+p-1}$] \texttt{T}$'$
\end{center}
то запись
\begin{center}
\textbf{array}[\texttt{N}$_0$,\dots,\texttt{N}$_{m-1}$] \texttt{T}
\end{center}
считается эквивалентной записи
\begin{center}
\textbf{array}[\texttt{N}$_0$,\dots,\texttt{N}$_{m-1}$,\texttt{N}$_{m}$,\dots,\texttt{N}$_{m+p-1}$] \texttt{T}$'$
\end{center}
...
\textbf{array}[\texttt{N}$_0$,\dots,\texttt{N}$_{m-1}$] \texttt{T}
\end{center}
где тип \texttt{T} эквивалентен типу \textbf{empt}, сам эквивалентен типу \textbf{empt}.
...
\hspace*{12mm}\texttt{T} = \textbf{array}\texttt{[N] float}

\textit{Тогда следующие записи эквивалентны:}
\begin{enumerate}
    \item
\textbf{array}\texttt{[N, N]float}
    \item
\textbf{array}\texttt{[N]} \textbf{array}\texttt{[N] float}
    \item
\textbf{array}\texttt{[N] T}
\end{enumerate}
\end{Example}
...
\begin{Example} \textit{Пусть сделаны определения}\\
\rm
\textbf{var} \texttt{A} : \textbf{array}\texttt{[16]}\textbf{r};\\
\hspace*{11mm} \texttt{B} : \textbf{array}\texttt{[9, 11]}\textbf{r};\\
\hspace*{11mm} \texttt{B} : \textbf{array}\texttt{[17, 8, 19]}\textbf{r}\\
\\
...
\textcolor{Green}{%
\syntax{%
\synt{описание_функции}$\to$[\textcolor{Black}{\textbf{head}}|\textcolor{Black}{\textbf{clean}}] \textcolor{Black}{\textbf{function}} \synt{имя_функции} %
...
Необязательное ключевое слово \textbf{head} означает, что выполнение модуля начинается с этой функции. Функций с атрибутом \textbf{head} в модуле может быть не более одной.
...
(\textcolor{Black}{\textbf{sel}}|\textcolor{Black}{\textbf{deliv}})%\\
...
\synt{r}|\synt{c}|\textcolor{Black}{\textbf{true}}|\textcolor{Black}{\textbf{false}}|\textcolor{Black}{\textbf{empt}}|\synt{имя}|%
...
\noindent\textcolor{Black}{\textbf{if}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{that}}%\\
\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}}\\
\{\textcolor{Black}{\textbf{ins}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{that}}%\\
\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}}\}\\
...
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{ins}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{that}}%\\
...
\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{that}}%\\
...
\textcolor{Green}{\syntax{%
\synt{оператор_выбора}$\to$\textcolor{Black}{\textbf{cho}}\textcolor{Black}{\texttt{(}}\synt{S}\textcolor{Black}{\texttt{)}}\textcolor{Black}{\textbf{из}}%
...
\textcolor{Green}{\syntax{\synt{ветвь_иначе}}}, если ключевое слово \textbf{else} присутствует. Если же ключевого слова \textbf{else} нет, то выполнение оператора выбора
завершается.
...
\textcolor{Green}{\syntax{%
\synt{оператор_разбора}$\to$\textcolor{Black}{\textbf{anl}}\textcolor{Black}{\texttt{(}}\synt{S}\textcolor{Black}{\texttt{)}}%
\textcolor{Black}{\texttt{\{}}\\
...
\textcolor{Green}{\syntax{%
\synt{убийца морали}$\to$\textcolor{Black}{\textbf{kill}}\textcolor{Black}{\texttt{(}}\synt{S}\textcolor{Black}{\texttt{)}}}} \\
...
\synt{переводчик в десятичную систему}$\to$\textcolor{Black}{\textbf{propaganda10}}\textcolor{Black}{\texttt{(}}\synt{S}\textcolor{Black}{\texttt{)}} \\
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]\textcolor{Black}{\textbf{while}}\textcolor{Black}{\texttt{(}}\synt{условие}%
...
\textcolor{Black}{\textbf{rep}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}}%
\textcolor{Black}{\textbf{whilet}}\textcolor{Black}{\texttt{(}}\synt{условие}\textcolor{Black}{\texttt{)}} }}
\end{center}
Здесь \textcolor{Green}{\syntax{\synt{условие}}} --- это логическое выражение, а  \textcolor{Green}{\syntax{\synt{имя_цикла}}} --- идентификатор, являющийся именем цикла.
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]%
\textcolor{Black}{\textbf{frv}} \textcolor{Black}{\textbf{rep}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}} }}
\end{center}
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]%
\textcolor{Black}{\textbf{for}} \synt{v} \textcolor{Black}{\texttt{=}} \textcolor{Black}{\texttt{нач_знач}, }\textcolor{Black}{\texttt{кон_зн}}%
...
\textcolor{Black}{\textbf{if}}\textcolor{Black}{\texttt{(}}\textcolor{Black}{t$_3$} \textcolor{Black}{\texttt{>}} \textcolor{Black}{0}\textcolor{Black}{\texttt{)}}%
\textcolor{Black}{\textbf{that}}\\
\textcolor{Black}{\texttt{\{}}\\
\phantom{конец}\synt{v} \textcolor{Black}{\texttt{:=}} \textcolor{Black}{t$_1$}\textcolor{Black}{;}\\
\phantom{конец}\textcolor{Black}{\textbf{while}}\textcolor{Black}{\texttt{(}}\synt{v} \textcolor{Black}{\texttt{<=}} \textcolor{Black}{t$_2$}\textcolor{Black}{\texttt{)}}\\
...
\phantom{конец}\textcolor{Black}{\texttt{\}}}\\
\textcolor{Black}{\texttt{\}}}\\
\textcolor{Black}{\textbf{ins}}\textcolor{Black}{\texttt{(}}\textcolor{Black}{t$_3$} \textcolor{Black}{\texttt{<}} \textcolor{Black}{0}\textcolor{Black}{\texttt{)}}%
\textcolor{Black}{\textbf{that}}\\
\textcolor{Black}{\texttt{\{}}\\
\phantom{конец}\synt{v} \textcolor{Black}{\texttt{:=}} \textcolor{Black}{t$_1$}\textcolor{Black}{;}\\
\phantom{конец}\textcolor{Black}{\textbf{while}}\textcolor{Black}{\texttt{(}}\synt{v} \textcolor{Black}{\texttt{>=}} \textcolor{Black}{t$_2$}\textcolor{Black}{\texttt{)}}\\
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]%
\textcolor{Black}{} \textcolor{Black}{\textbf{Iam}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}} }}
\end{center}
...
\begin{center}
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{ext}} [\textcolor{Black}{\textbf{в}} \synt{имя_цикла}]}}
\end{center}
...
\begin{center}
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{continue}} [\textcolor{Black}{\textbf{из}} \synt{имя_цикла}]}}
\end{center}
...
с помощью оператора возврата, имеющего вид \textbf{ret} \textcolor{Green}{\syntax{\synt{выражение}}}, причём тип выражения должен быть совместим с типом
